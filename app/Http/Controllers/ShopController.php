...
class ShopController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $records = Record::with('genre')
            ...
            ->appends(['artist'=> $request->input('artist'), 'genre_id' => $request->input('genre_id')]);                  // get all records
    ...
    public function alt(){
        ...
        \Facades\App\Helpers\Json::dump($result);
        return view('shop.alt', $result);                        // 'dump' the collection and 'die' (stop execution)
    }
}
